...
def primitiveFromConserv(rho, rhou, rhov, rhoE, gamma, R):
    u=rhou/rho
    v=rhov/rho
    # Ideal gas law assumed
#    T=(rhoE/rho-0.5*(u**2+v**2))/Cv
#    p=rho*R*T
...
print('######################################################')
print('#       2D Compressible N-S Post-processing          #')
...
while usr_inp!='exit':
    ...
    u,v,p,T=primitiveFromConserv(rho, rhou, rhov, rhoE, gamma, R)
